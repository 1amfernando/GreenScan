...
window.GS_RELEASES_ARCHIVE = [
  ...
  // ── v32.04: aus index.html hierher ausgelagert (CLAUDE.md §3.1) ──
  {
    ...
    headline: '\ud83d\udd0d Die Suchliste zeigte weiter „Essbar", was die Detailkarte schon zur\u00fcckgenommen hatte',
    summary: 'Die gr\u00fcne Plakette war auf der Artenkarte weg \u2014 in der Trefferliste stand sie noch. Und die Trefferliste sieht man ZUERST. Dazu: bei gleicher Relevanz kommen gepr\u00fcfte Eintr\u00e4ge nach oben.',
    user_summary: '\ud83d\udd0d In der Suche stehen gepr\u00fcfte Arten zuoberst, und ungepr\u00fcfte tragen dort dieselbe Kennzeichnung wie auf ihrer Karte.',
    user_items: [
      {emoji:'\ud83d\udd0d', bold:'Eine halbe Korrektur ist keine:', text:' Gestern habe ich die gr\u00fcne „Essbar"-Plakette auf ungepr\u00fcften Artenkarten zur\u00fcckgenommen. In der Trefferliste stand sie weiter \u2014 und die sieht man vor der Karte. Jetzt steht dort „\u2753 nicht gepr\u00fcft", und der gr\u00fcne Rand der Karte f\u00e4llt ebenfalls weg.'},
      {emoji:'\u2b06\ufe0f', bold:'Gepr\u00fcfte Arten zuerst:', text:' „Brennnessel" trifft neun Eintr\u00e4ge, „Ampfer" achtundzwanzig. Bei gleicher Relevanz entschied bisher das Alphabet. Jetzt kommt der Eintrag mit Warnhinweis und Verwechslungsangabe zuerst \u2014 die Relevanz selbst bleibt unangetastet, ein exakter Treffer schl\u00e4gt weiterhin alles.'},
    ],
  },
  {
    v: 'v31.90', date: '02.09.2026',
    headline: '\u2753 Was nie gepr\u00fcft wurde, sagt es jetzt \u2014 statt gr\u00fcn „Essbar" zu zeigen',
    summary: '1383 Eintr\u00e4ge aus der Buch-Einlese haben weder Warnhinweis noch Verwechslungsangabe noch Saison. 68 davon behaupteten „essbar" mit gr\u00fcner Plakette. Die App hatte f\u00fcr genau diesen Fall schon einen Mechanismus \u2014 er war nur nie auf diese Eintr\u00e4ge angewandt.',
    user_summary: '\u2753 Arten ohne redaktionelle Pr\u00fcfung zeigen jetzt „Einstufung offen" statt einer gr\u00fcnen Essbar-Plakette.',
    user_items: [
      {emoji:'\u2753', bold:'Keine gr\u00fcne Zusage ohne Pr\u00fcfung:', text:' 1383 Eintr\u00e4ge tragen weder Warnhinweis noch Verwechslungsangabe noch Saison \u2014 die drei Felder, an denen man einen bearbeiteten Eintrag erkennt. 68 davon zeigten trotzdem „\ud83c\udf7d\ufe0f Essbar" in Gr\u00fcn. Jetzt steht dort „Einstufung offen \u00b7 Noch nicht gepr\u00fcft".'},
      {emoji:'\u267b\ufe0f', bold:'Kein neuer Mechanismus:', text:' Die App unterdr\u00fcckt gr\u00fcne Plaketten bei ungepr\u00fcften Arten seit Juni \u2014 bisher nur bei Community-Vorschl\u00e4gen. Er gilt jetzt auch f\u00fcr die Buch-Einlese. Es wird nichts hinzugedichtet: es werden POSITIVE Behauptungen zur\u00fcckgenommen, die die Daten nicht tragen.'},
      {emoji:'\u26a0\ufe0f', bold:'Warnungen bleiben stehen:', text:' Zur\u00fcckgehalten wird nur die Entwarnung. Wo ein Eintrag als giftig eingestuft ist, steht die Warnung unver\u00e4ndert \u2014 im Zweifel lieber eine Warnung zu viel.'},
      {emoji:'\ud83e\uddea', bold:'Und ein eigener Fehler, gefunden weil ich die Karte angesehen habe:', text:' Meine erste Fassung stand im Code VOR der Zeile, die das Pr\u00fcf-Kennzeichen liest \u2014 sie lief also nie, ohne Fehlermeldung. Aufgefallen nur, weil der Test die fertige Karte gelesen hat und nicht den Code.'},
    ],
  },
  {
    v: 'v31.89', date: '02.09.2026',
    headline: '\u26a0\ufe0f Bei 25 giftigen Arten stand „verwendbar" auf derselben Karte wie „nicht essen"',
    summary: 'Gefunden beim Ausmessen der Arten-L\u00fccken: 1408 Eintr\u00e4ge tragen denselben Standardsatz im Feld Verwendung. Bei 25 davon stuft der Datensatz die Art selbst als stark giftig ein \u2014 darunter Eisenhut, Rebendolde, Stechapfel, Fingerhut und Seidelbast.',
    user_summary: '\u26a0\ufe0f Wichtig: Bei 25 giftigen Arten stand unter „Verwendung" ein Standardsatz, der zum Sammeln einlud. Behoben.',
    user_items: [
      {emoji:'\u26a0\ufe0f', bold:'Was los war:', text:' 1408 Eintr\u00e4ge aus der Bucheinlese tragen im Feld „Verwendung" denselben Satz: „Junge Bl\u00e4tter, Bl\u00fcten oder Samen je nach Art verwendbar." Bei 25 davon sagt derselbe Datensatz gleichzeitig „\u26a0\ufe0f Giftig \u2014 nicht essen." Betroffen sind Gattungen wie Eisenhut, Rebendolde, Stechapfel und Fingerhut \u2014 die gef\u00e4hrlichsten Pflanzen Mitteleuropas.'},
      {emoji:'\u2705', bold:'Was jetzt gilt:', text:' Wo der Datensatz die Art selbst als giftig einstuft, steht dort „Keine Verwendung \u2014 dieser Eintrag ist als giftig eingestuft." Es wird nichts botanisch neu entschieden: entfernt wird nur ein allgemeiner Satz, der der eigenen Einstufung des Eintrags widerspricht.'},
      {emoji:'\ud83d\udd0e', bold:'Und damit es nicht zur\u00fcckkommt:', text:' Der Pr\u00fcfstand meldet ab sofort jeden allgemeinen Text, der auf einer als giftig eingestuften Art eine Verwendung verspricht. Sorgf\u00e4ltig geschriebene Eintr\u00e4ge \u00fcber teilweise essbare Arten (Robinie, Tintling) werden dabei NICHT angeschw\u00e4rzt \u2014 der Unterschied ist messbar: ein Text auf 1400 Arten sagt \u00fcber keine einzelne etwas.'},
      {emoji:'\ud83d\udcd0', bold:'Der ganze Befund:', text:' steht in docs/ARTEN-L\u00dcCKEN.md \u2014 samt der Erkenntnis, dass die Datenl\u00fccken nicht verteilt sind, sondern sich auf 1276 unbearbeitete Eintr\u00e4ge aus der Bucheinlese konzentrieren. Die gepflegten 3066 Arten sind zu 94\u2013100 % vollst\u00e4ndig.'},
    ],
  },
  {
    v: 'v31.88', date: '02.09.2026',
    headline: '\ud83e\uddf1 Der Planer setzt nichts mehr auf den Weg',
    summary: 'Wer seinen Garten gescannt hat, hat Beete \u2014 und dazwischen Wege, Rasen, eine Terrasse. Der Platzierer kannte bisher nur EIN Rechteck: die ganze Fl\u00e4che. Jetzt respektiert er deine gescannten Beete.',
    user_summary: '\ud83e\uddf1 Neue Pflanzen landen jetzt in deinen gescannten Beeten statt irgendwo auf der Fl\u00e4che.',
    user_items: [
      {emoji:'\ud83e\uddf1', bold:'Beete statt Fl\u00e4che:', text:' Der Platzierer kannte nur die Gesamtfl\u00e4che und konnte eine Tomate mitten auf den Weg legen. Jetzt sind die Beete aus deinem Garten-Scan eine Vorliebe \u2014 und zwar die, die ZULETZT aufgegeben wird: eine Pflanze im falschen Licht w\u00e4chst schlecht, eine auf dem Weg w\u00e4chst gar nicht.'},
      {emoji:'\u2696\ufe0f', bold:'Aber keine Sperre:', text:' Passt nicht alles ins Beet, wird trotzdem gesetzt \u2014 und gesagt, wer draussen liegt. Eine Pflanze wegzulassen w\u00e4re die schlechtere Antwort, und ein Plan, der behauptet alles passe, w\u00e4re kein Plan.'},
      {emoji:'\ud83d\udd0d', bold:'Und wenn nichts gescannt ist:', text:' \u00e4ndert sich gar nichts. Ohne Beete keine Einschr\u00e4nkung \u2014 nachgepr\u00fcft: dieselben Positionen wie vorher, auf den Zentimeter.'},
    ],
  },
  {
    v: 'v31.87', date: '02.09.2026',
    headline: '\ud83e\udde0 „Plan f\u00fcr diesen Garten" \u2014 ein Tipp statt vier Schritte',
    summary: 'Die App hat alle Angaben deines Gartens. Trotzdem musste man den Planer \u00f6ffnen, die Vorlagen-Liste finden und durch vier Schritte klicken. Jetzt steht der Knopf dort, wo der Garten steht.',
    user_summary: '\ud83e\udde0 Auf jeder Gartenkarte: „Plan f\u00fcr diesen Garten" \u2014 Masse, Licht, Boden und Art sind sofort \u00fcbernommen.',
    user_items: [
      {emoji:'\ud83e\udde0', bold:'Ein Tipp statt vier Schritte:', text:' Der Knopf \u00f6ffnet den Planer, \u00fcbernimmt Masse, Standort, Licht, Boden und die Art des Gartens \u2014 und springt direkt zum letzten Schritt, wo „Plan generieren" steht.'},
      {emoji:'\ud83c\udfe0', bold:'Bei einem Gew\u00e4chshaus:', text:' setzt sich der Gew\u00e4chshaus-Modus gleich mit, und es steht in der Meldung, was \u00fcbernommen wurde. Nachgepr\u00fcft: Breite 4, L\u00e4nge 8, Ort Bern, Boden lehmig, Vollsonne, Gew\u00e4chshaus-Modus an.'},
      {emoji:'\u270b', bold:'Was NICHT von selbst passiert:', text:' Der Plan wird nicht ungefragt erzeugt. Ein Aufruf, der von allein startet, kostet Kontingent und \u00fcberrascht \u2014 der letzte Schritt geh\u00f6rt dir, samt Platz f\u00fcr W\u00fcnsche.'},
    ],
  },
  {
    v: 'v31.86', date: '02.09.2026',
    headline: '\ud83c\udf31 „Jetzt dran" \u2014 dein Saatgut wei\u00df, wann es Zeit ist',
    summary: 'Zwei Verbindungen, die es nicht gab, obwohl beide Seiten seit Langem da sind: dein Saatgut-Inventar und der Aussaatkalender, deine erfassten Arten und ihre Bl\u00fctezeiten. In „Mein Garten" steht jetzt, was diesen Monat dran ist.',
    user_summary: '\ud83c\udf31 „Mein Garten" sagt dir jetzt, welches Saatgut du gerade s\u00e4en kannst \u2014 und was von deinen Arten bl\u00fcht.',
    user_items: [
      {emoji:'\ud83c\udf31', bold:'Dein Saatgut trifft den Kalender:', text:' Die App wusste, was in deiner Schublade liegt, und sie wusste, wann welche Kultur ges\u00e4t wird \u2014 nur nie beides zusammen. Jetzt steht in „Mein Garten": „Jetzt vorziehen: …" oder „Jetzt ins Beet: … \u2014 Saatgut hast du." Abgelaufenes wird nicht empfohlen, sondern gemeldet.'},
      {emoji:'\ud83c\udf3b', bold:'Und was bei dir bl\u00fcht:', text:' Aus deinen erfassten Arten, mit den gepr\u00fcften Saison-Angaben. Wer nichts erfasst hat, sieht die Zeile gar nicht \u2014 eine Kachel, die „nichts" meldet, ist Platz ohne Aussage.'},
      {emoji:'\ud83c\udf45', bold:'Eine Korrektur beim Bauen:', text:' Der erste Anlauf schrieb „Bl\u00fcht im September: Monstera, Fleischtomate". Beides falsch, und aus demselben Grund wie bei den Pilzen: das Datenfeld hei\u00dft SAISON. Bei Wildpflanzen und Kr\u00e4utern ist das die Bl\u00fcte, bei Gem\u00fcse die ERNTE, bei Zimmerpflanzen die Verf\u00fcgbarkeit. Eine Tomate im September bl\u00fcht nicht, sie ist reif. Gilt jetzt auch im Bl\u00fchkalender.'},
    ],
  },
  {
    v: 'v31.85', date: '02.09.2026',
    headline: '\ud83d\udcbe Ein Pr\u00fcfstand, der jeden Speicherweg wirklich zu Ende f\u00e4hrt',
    summary: 'Die teuersten Fehler dieses Meilensteins lagen alle beim Speichern: Gartenmasse wurden nie geschrieben, der Garten-Zwilling meldete Erfolg ohne zu speichern, der Plan ebenso. Jetzt f\u00e4hrt ein Werkzeug sieben Wege zu Ende \u2014 Formular f\u00fcllen, speichern, zur\u00fccklesen, vergleichen.',
    user_summary: '\ud83d\udcbe Ein neues Pr\u00fcfwerkzeug stellt sicher, dass wirklich ankommt, was du speicherst \u2014 Garten, Pflanzung, Saatgut, Plan und mehr.',
    user_items: [
      {emoji:'\ud83d\udcbe', bold:'Sieben Speicherwege, wirklich gefahren:', text:' Garten (mit Massen, Art, Licht, Boden) \u00b7 Pflanzung (mit Sorte, Datum, Anzahl, Notiz) \u00b7 Saatgut \u00b7 Einstellungen \u00b7 Garten-Zwilling \u00b7 Plan \u00b7 Aufgaben-Fortschritt. Jeder wird gef\u00fcllt, gespeichert, aus dem Ger\u00e4tespeicher zur\u00fcckgelesen und Feld f\u00fcr Feld verglichen.'},
      {emoji:'\ud83e\uddea', bold:'Und die Gegenprobe:', text:' Ein Pr\u00fcfstand, der beim ersten Lauf „alles gr\u00fcn" meldet, ist erst dann etwas wert, wenn er auch einen Fehler findet. Ich habe zwei Felder absichtlich kaputt gemacht \u2014 er nannte beide beim Namen, samt erwartetem Wert. Danach zur\u00fcckgesetzt.'},
      {emoji:'\ud83d\udd13', bold:'Was ihn vorher unm\u00f6glich machte:', text:' Mehrere Speicherwege beginnen mit einer Anmelde-Sperre, an der jeder Pr\u00fcfstand abbricht \u2014 er h\u00e4tte eine Funktion vermessen, die gar nicht l\u00e4uft. Die Sperre wird jetzt bewusst \u00fcberbr\u00fcckt, und warum, steht im Werkzeug selbst.'},
    ],
  },
  {
    v: 'v31.84', date: '02.09.2026',
    headline: '\ud83c\udf27\ufe0f Nach dem Regen sagt die App, dass Giessen warten kann',
    summary: 'Die App holt seit Langem st\u00fcndliche Niederschlagswerte und f\u00fchrt einen Giessplan. Beides lief nebeneinander her: nach einem Gewitter stand am n\u00e4chsten Morgen „Giessen f\u00e4llig" f\u00fcr den Balkon, als w\u00e4re nichts gewesen.',
    user_summary: '\ud83c\udf27\ufe0f Hat es geregnet, steht das jetzt bei der Giess-Aufgabe \u2014 mit der gemessenen Menge.',
    user_items: [
      {emoji:'\ud83c\udf27\ufe0f', bold:'Regen und Giessplan wussten nichts voneinander:', text:' Jetzt steht bei einer f\u00e4lligen Giess-Aufgabe, wie viel heute schon gefallen ist \u2014 in „N\u00e4chste Schritte" und im Benachrichtigungs-Fenster. Nichts Neues geholt, nur zusammengebracht, was die App l\u00e4ngst wei\u00df.'},
      {emoji:'\ud83d\udccf', bold:'Drei Regeln, damit daraus keine falsche Zusage wird:', text:' Gemessen wird, was GEFALLEN ist (die Stunden von Mitternacht bis jetzt) \u2014 eine Vorhersage ist kein Regen. Nur f\u00fcr Pflanzen, von denen die App wei\u00df, dass sie drau\u00dfen stehen \u2014 im Gew\u00e4chshaus und im Wohnzimmer regnet es nicht. Und die Aufgabe verschwindet NICHT: sie bekommt einen Vermerk, du entscheidest.'},
      {emoji:'\ud83e\udd14', bold:'Und wenn die App es nicht wei\u00df:', text:' sagt sie nichts. Eine Pflanze ohne Standort-Angabe bekommt keinen Hinweis \u2014 lieber keine Aussage als eine erfundene.'},
    ],
  },
  {
    v: 'v31.83', date: '02.09.2026',
    headline: '\ud83d\udcca Vier Zahlen zuerst \u2014 und der Planer-Kopf passt endlich auf den Bildschirm',
    summary: 'Das Plan-Ergebnis beginnt jetzt mit Fl\u00e4che, Artenzahl, gepr\u00fcfter Ernte und Arbeitsspitze \u2014 alle vier gerechnet, keine aus der KI-Antwort. Und der \u00fcberladene Kopfbereich steht auf zwei Zeilen statt einer.',
    user_summary: '\ud83d\udcca Der fertige Plan sagt dir in einer Zeile, worum es geht: wie gross, wie viele Arten, wie viel Ernte, wie viel Arbeit.',
    user_items: [
      {emoji:'\ud83d\udcca', bold:'Vier Zahlen als erster Blick:', text:' Fl\u00e4che \u00b7 Arten \u00b7 Ernte \u00b7 Handgriffe pro Woche in der dichtesten Zeit. Alle vier sind gerechnet \u2014 die Ernte aus den gepr\u00fcften Ertr\u00e4gen, der Aufwand aus dem Pflegeplan. Wo nichts gerechnet werden konnte, steht ein Strich und keine Null: „0 kg" und „keine Angabe" sind verschiedene Aussagen.'},
      {emoji:'\ud83e\uddf1', bold:'Der Kopfbereich passt wieder:', text:' Titel und drei Werkzeug-Kn\u00f6pfe standen in EINER Reihe. Auf einem Telefon blieben der \u00dcberschrift 96 von 412 Pixeln \u2014 „KI-Gartenplaner PRO" brach auf drei Zeilen, die Unterzeile auf acht, und der dritte Knopf ragte rechts hinaus. Jetzt zwei Zeilen: Titel oben \u00fcber die volle Breite, Werkzeuge darunter.'},
      {emoji:'\ud83c\udfa8', bold:'Zwei Stellen, die dabei auffielen:', text:' Die Unterzeile war zu 75 % durchsichtig (3,5:1) und der Kn\u00f6pf „B\u00e4ume" zu hell (4,1:1) \u2014 beide erst messbar, seit der Kopf richtig umbricht. Ein zusammengequetschter Text entzieht sich der Pr\u00fcfung: was nicht richtig gerendert wird, wird auch nicht richtig gemessen.'},
    ],
  },
  {
    v: 'v31.82', date: '02.09.2026',
    headline: '\ud83c\udfe0 Gew\u00e4chshaus, Treibhaus, Hochbeet \u2014 dein Garten hat jetzt eine Art',
    summary: 'Den Begriff gab es in der App bisher nicht: nur eine Gr\u00f6ssenstufe und einen Haken im Planer, den man jedes Mal von Hand setzen musste. Jetzt geh\u00f6rt die Art zum Garten, steht auf der Karte, und der Planer \u00fcbernimmt sie samt Gew\u00e4chshaus-Modus.',
    user_summary: '\ud83c\udfe0 Sag beim Garten, ob es ein Gew\u00e4chshaus, ein Hochbeet oder ein Balkon ist \u2014 der Planer wei\u00df es dann von selbst.',
    user_items: [
      {emoji:'\ud83c\udfe0', bold:'Sieben Arten zur Wahl:', text:' Freiland-Beet, Hochbeet, Balkon/Terrasse, Gew\u00e4chshaus, Folientunnel/Treibhaus, Wintergarten, Zimmer. Die Art steht im Formular, wird gespeichert, beim Bearbeiten wieder eingelesen und auf der Gartenkarte angezeigt \u2014 alle vier Stellen, damit nicht wieder etwas nur geschrieben und nie gelesen wird.'},
      {emoji:'\ud83c\udf3b', bold:'Das Symbol sagt jetzt etwas:', text:' Auf jeder Gartenkarte stand dieselbe Sonnenblume \u2014 h\u00fcbsch, aber ohne Aussage; ein Gew\u00e4chshaus sah aus wie ein Balkon. Jetzt tr\u00e4gt jede Karte ihr eigenes Zeichen.'},
      {emoji:'\ud83e\ude9f', bold:'Der Planer wei\u00df Bescheid:', text:' W\u00e4hlst du dein Gew\u00e4chshaus als Vorlage, setzt sich der Gew\u00e4chshaus-Modus von selbst \u2014 und es wird gesagt, dass er sich gesetzt hat. W\u00e4hlst du danach den Balkon, geht er wieder aus. Unter Glas gelten andere Aussaatfenster, keine Eisheiligen-Grenze und eine l\u00e4ngere Saison; das ist keine Nebensache.'},
    ],
  },
  {
    v: 'v31.81', date: '02.09.2026',
    headline: '\ud83d\uddbc\ufe0f Galerie neben dem Ausl\u00f6ser \u2014 und Mitteilungen f\u00fchren endlich irgendwohin',
    summary: 'Der Weg „Foto aus der Galerie" stand als kleines Symbol zwischen f\u00fcnf anderen in der oberen Leiste. Er steht jetzt beschriftet neben dem Ausl\u00f6ser. Und eine angetippte Mitteilung landete bei unbekannter Art nur beim Schliessen des Fensters \u2014 jetzt f\u00fchren 31 Arten an ihren Ort.',
    user_summary: '\ud83d\uddbc\ufe0f Kamera oder Galerie \u2014 beide Wege stehen jetzt gleichberechtigt nebeneinander. Und wenn du eine Mitteilung antippst, kommst du dorthin, wo sie hingeh\u00f6rt.',
    user_items: [
      {emoji:'\ud83d\uddbc\ufe0f', bold:'Galerie neben dem Ausl\u00f6ser:', text:' Bisher lag der zweite Weg in den Scanner als kleines Symbol zwischen f\u00fcnf gleich aussehenden in der oberen Leiste \u2014 wer keine Kamera benutzen will oder kann, fand ihn nicht. Jetzt steht er unten, beschriftet, gleich neben dem Ausl\u00f6ser. Oben ist er daf\u00fcr weg: ein Umzug, kein Doppel. Und alle Nebenkn\u00f6pfe tragen jetzt ein Wort \u2014 ein blosses Emoji sagt nicht, was es tut.'},
      {emoji:'\ud83d\udd14', bold:'Mitteilungen f\u00fchren an ihren Ort:', text:' Der Wegweiser kannte sieben Arten von Mitteilungen. Alle anderen landeten bei „Fenster schliessen" \u2014 ein Tipp ins Leere. Jetzt sind es 31: Ernte und Wetter in den Garten, Likes und Kommentare in die Community, Nachrichten in den Marktplatz-Posteingang, Abo-Hinweise ins Abo.'},
      {emoji:'\ud83e\udded', bold:'Und wenn wirklich kein Ziel bekannt ist:', text:' sagt die App das jetzt, statt so zu tun, als w\u00e4re nichts gewesen. Ein neuer Pr\u00fcfstand-Teil f\u00e4hrt alle 31 Arten durch und meldet jede, die ins Leere zeigt \u2014 beim ersten Lauf hat er prompt drei eigene Fehler von mir gefunden.'},
    ],
  },
  {
    v: 'v31.80', date: '02.09.2026',
    headline: '\ud83d\udd2c Neuer Pr\u00fcfstand: gibt es \u00fcberhaupt, was der Code liest?',
    summary: 'Nach dem Bl\u00fchkalender-Fund (ein Feld, das in keiner der 4342 Arten existiert) ein Werkzeug, das genau diese Fehlerklasse findet \u2014 dynamisch, nicht per Textsuche. Erster Durchlauf: ein weiterer Zugriff ins Leere, 26042-mal.',
    user_summary: '\ud83d\udd2c Ein neues Pr\u00fcfwerkzeug findet Stellen, an denen die App Daten liest, die es gar nicht gibt \u2014 lautlose Fehler, die nichts abst\u00fcrzen lassen.',
    user_items: [
      {emoji:'\ud83d\udd2c', bold:'Die dritte Frage:', text:' Bisher pr\u00fcften zwei Werkzeuge, ob ankommt was du antippst, und ob jemand liest was du eingibst. Das neue fragt: GIBT es, was gelesen wird? Es h\u00e4ngt sich an die Artendatenbank und schreibt jeden Feldzugriff mit \u2014 jeder Zugriff auf einen Namen, den kein Datensatz kennt, ist ein belegter Fund, kein Verdacht.'},
      {emoji:'\ud83d\udc1d', bold:'Erster Fund:', text:' Die Bienen-Erkennung durchsuchte drei Textfelder einer Art \u2014 eines davon gibt es an Arten gar nicht (26042 Zugriffe ins Leere). Ein Drittel ihrer Beweislage war immer leer. Behoben; die Erkennung bleibt trotzdem schwach, und genau deshalb ist sie seit gestern ehrlich beschriftet.'},
      {emoji:'\ud83d\udcd0', bold:'Und eine Deckungs-\u00dcbersicht:', text:' Der Pr\u00fcfstand meldet jetzt auch Felder, die zwar existieren, aber bei \u00fcber der H\u00e4lfte der Arten leer sind \u2014 Bl\u00fctenfarbe etwa steht nur bei 22 % der Arten. Wer eine Anzeige darauf baut, sollte das wissen.'},
    ],
  },
  {
    v: 'v31.79', date: '02.09.2026',
    headline: '\ud83d\udcf7 Scanner V2: erst messen, dann bestimmen',
    summary: 'Die Bildqualit\u00e4t wurde bisher nur an der Live-Kamera gepr\u00fcft \u2014 Galerie, Teilen-Dialog und abgelegte Dateien kamen ungepr\u00fcft durch. Jetzt wird jedes Foto vorher vermessen. Dazu ein ehrlicher Fortschritt statt f\u00fcnf Meldungen nach Stoppuhr, und die Sicherheitsangabe kann nicht mehr um den Faktor 100 danebenliegen.',
    user_summary: '\ud83d\udcf7 Der Scanner sagt dir jetzt VOR der Bestimmung, wenn ein Foto zu unscharf oder zu dunkel ist \u2014 das spart dir einen Versuch aus dem Tageskontingent.',
    user_items: [
      {emoji:'\ud83d\udcf7', bold:'Jedes Foto wird vorher vermessen:', text:' Sch\u00e4rfe und Licht wurden bisher NUR an der eigenen Kamera gepr\u00fcft \u2014 drei der vier Wege in den Scanner (Galerie, Teilen, Datei ablegen) kamen ungepr\u00fcft durch. Bei einem wirklich unlesbaren Foto siehst du jetzt vorher die gemessenen Werte und entscheidest selbst: neues Foto oder trotzdem bestimmen. Geblockt wird nichts.'},
      {emoji:'\u23f1\ufe0f', bold:'Ehrlicher Fortschritt:', text:' W\u00e4hrend des Scans liefen f\u00fcnf Meldungen nach Stoppuhr ab \u2014 „Merkmale werden gelesen", „Doppelg\u00e4nger werden gepr\u00fcft" \u2014 w\u00e4hrend die App in Wahrheit auf EINEN Netzaufruf wartete. Der Balken darunter war eine Animation von 0 auf 92 %. Jetzt melden nur die Schritte, die wirklich stattfinden, und beim Warten steht dort die verstrichene Zeit \u2014 die ist gemessen und stimmt.'},
      {emoji:'\ud83c\udfaf', bold:'Die Sicherheitsangabe kann nicht mehr um 100 danebenliegen:', text:' Liefert das Modell einmal 0.42 statt 42, stand dort bisher „0.42 %". Das liest sich als „so gut wie nichts", gemeint war „nicht ganz die H\u00e4lfte". Jetzt gilt \u00fcberall dieselbe Regel \u2014 und im Zweifel die vorsichtigere Lesart.'},
    ],
  },
  {
    v: 'v31.78', date: '02.09.2026',
    headline: '\ud83c\udf3b Der Bl\u00fchkalender war zur H\u00e4lfte leer \u2014 seit jeher',
    summary: 'Der Reiter „Wild" las ein Datenfeld, das in keiner der 4342 Arten existiert. Er zeigte deshalb immer null Ergebnisse. Jetzt kommen die Angaben aus der echten Saison-Spalte: allein im Juni sind es 1395 Arten. Dazu ein neuer Reiter „Meine", ein Jahresband je Art und Marken f\u00fcr essbar/giftig/gesch\u00fctzt.',
    user_summary: '\ud83c\udf3b Der Bl\u00fchkalender zeigt endlich Wildbl\u00fcten \u2014 und deine eigenen Arten mit Bl\u00fctezeit auf einen Blick.',
    user_items: [
      {emoji:'\ud83c\udf3f', bold:'Der Reiter „Wild" war immer leer:', text:' Er fragte ein Feld ab, das es in der Artendatenbank nicht gibt \u2014 bei keiner einzigen der 4342 Arten. Der Z\u00e4hler daneben sagte brav „0", als w\u00e4re das ein Ergebnis. Jetzt kommen die Bl\u00fchzeiten aus der gepflegten Saison-Angabe: im Juni allein 1395 Arten.'},
      {emoji:'\ud83e\udeb4', bold:'Neuer Reiter „Meine":', text:' Deine gepflegten Pflanzen, deine best\u00e4tigten Bestimmungen und deine letzten Scans \u2014 zugeordnet zur Artendatenbank und nach Bl\u00fctezeit sortiert. Damit siehst du deine eigene Bl\u00fctenfolge \u00fcber das Jahr.'},
      {emoji:'\ud83d\udcc5', bold:'Ein Jahresband je Art:', text:' Zw\u00f6lf Punkte zeigen sofort, ob etwas zwei Wochen oder ein halbes Jahr bl\u00fcht. Dazu Marken f\u00fcr essbar, giftig, gesch\u00fctzt, Bl\u00fctenfarbe und H\u00f6henlage \u2014 in einer App, die Giftiges von Essbarem unterscheidet, geh\u00f6rt die Warnung in jede Liste.'},
      {emoji:'\ud83c\udf3c', bold:'Bl\u00fch-L\u00fccke:', text:' In welchen Monaten bl\u00fcht von DEINEN Arten gar nichts? Der erste Anlauf wollte eine Best\u00e4uber-L\u00fccke rechnen \u2014 aber die Bienen-Erkennung findet die Worte „Bienen" oder „Nektar" nur bei 78 von 4342 Arten, nicht einmal bei L\u00f6wenzahn. Ein Fehlalarm im Gewand einer Erkenntnis ist schlechter als gar keine Anzeige; der Schalter sagt jetzt ehrlich, was er tut.'},
      {emoji:'\ud83d\udd2c', bold:'Und der Pr\u00fcfstand:', text:' Der Kontrast-Pr\u00fcfstand \u00f6ffnet jetzt auch den Bl\u00fchkalender \u2014 zwei Fenster, 392 Textstellen, 0 unter der Schwelle in beiden Modi.'},
    ],
  },
  {
    v: 'v31.77', date: '02.09.2026',
    headline: '\ud83d\udd0e Jede Pflanze sagt, warum sie dort steht \u2014 und der Pr\u00fcfstand schaut endlich ins Fenster',
    summary: 'Neue Marken an jeder Pflanze („Licht passt", „Saatgut vorhanden", „Familie stand vor 1 Jahr im Beet"). Dazu zwei neue Regeln \u2014 Standdauer und Fruchtfolge gegen deine echte Historie. Und der Kontrast-Pr\u00fcfstand misst jetzt auch im Planer-Fenster: 43 unlesbare Stellen gefunden und behoben.',
    user_summary: '\ud83d\udd0e Jede Pflanze im Plan sagt jetzt, warum sie dort steht \u2014 und der ganze Planer ist im Dunkelmodus endlich lesbar.',
    user_items: [
      {emoji:'\ud83d\udd0e', bold:'Warum steht sie hier?', text:' Unter jeder Pflanze im Plan stehen jetzt kleine Marken: „Licht passt (gemessen)", „Saatgut vorhanden (M\u00e4r 2027)", „Familie stand vor 1 Jahr im Beet". Alles davon ist gerechnet, nicht von der KI behauptet \u2014 und deshalb kannst du widersprechen.'},
      {emoji:'\u23f3', bold:'Standdauer:', text:' „K\u00fcrbis: 29 Tage von der Aussaat bis zur Ernte, die Referenz nennt rund 122." Ein Datum, das verrutscht ist, sieht im Plan normal aus \u2014 man merkt es erst, wenn die Ernte ausbleibt.'},
      {emoji:'\ud83d\udd01', bold:'Fruchtfolge gegen deine echte Historie:', text:' Aus deinen erfassten Pflanzungen und Ernten wird je Familie das Jahr der letzten Anwesenheit berechnet. Drei Jahre Pause beugt Bodenm\u00fcdigkeit vor. „Meine Pflanzen" z\u00e4hlt dabei nur als Hinweis \u2014 die Liste sagt WAS du h\u00e4ltst, nicht WO.'},
      {emoji:'\ud83c\udfa8', bold:'Der Planer war im Dunkelmodus stellenweise unlesbar:', text:' Weisse Kasten mit heller Schrift, dunkelbraune \u00dcberschriften auf dunklem Grund \u2014 43 Stellen unter der Lesbarkeitsschwelle, einige praktisch unsichtbar. Alle behoben; der Pr\u00fcfstand meldet jetzt 0 in beiden Modi.'},
      {emoji:'\ud83d\udd2c', bold:'Und warum das niemand gemerkt hat:', text:' Der Kontrast-Pr\u00fcfstand hat nur die elf Hauptbildschirme vermessen \u2014 was in einem Fenster steckt, sah er nie. Er \u00f6ffnet den Planer jetzt selbst und scrollt ihn durch. Gestern hat mich diese L\u00fccke sogar eine falsche \u201eKorrektur\u201c gekostet, die eine Stelle schlechter gemacht hat; die ist zur\u00fcckgenommen.'},
    ],
  },
  {
    v: 'v31.76', date: '02.09.2026',
    headline: '\u23f1\ufe0f Der gespeicherte Plan meldet sich \u2014 und das Speichern funktioniert wirklich',
    summary: 'Ein Plan aus dem Speicher zeigt jetzt, was seither passiert ist: was abgehakt ist, welcher Termin verstrichen. Dazu Frost- und Aufwand-Pr\u00fcfung \u2014 und ein Rettungsweg beim Plan-Speichern, der bis heute toter Code war.',
    user_summary: '\u23f1\ufe0f Ein gespeicherter Plan sagt dir jetzt, wo du stehst \u2014 und beim vollen Ger\u00e4t geht der Plan nicht mehr still verloren.',
    user_items: [
      {emoji:'\u23f1\ufe0f', bold:'Der Plan altert und meldet sich:', text:' \u00d6ffnest du einen gespeicherten Plan, steht ganz oben, was seit damals passiert ist \u2014 wie viele Schritte du umgesetzt hast und welcher Aussaattermin inzwischen f\u00e4llig war. Ohne KI-Aufruf, alles nachgerechnet. Ein Plan, der sich nie wieder meldet, ist ein PDF.'},
      {emoji:'\ud83d\udcbe', bold:'Plan speichern ging bei vollem Ger\u00e4t still schief:', text:' Der Rettungsweg lag in einem `catch`, das in dieser App nie ausl\u00f6st \u2014 derselbe Fehler wie beim Garten-Zwilling im Juli. Die App meldete „gespeichert" und hatte nichts. Jetzt wird der R\u00fcckgabewert gepr\u00fcft, der neue Plan hat Vorrang vor den alten, und wenn daf\u00fcr alte weichen mussten, wird es gesagt. Beides ausprobiert, nicht nur behauptet.'},
      {emoji:'\u2744\ufe0f', bold:'Frost, mit dem n\u00f6tigen Unterschied:', text:' Frostempfindliches vor Mitte Mai ins Freiland ist ein Fehler \u2014 dieselbe Pflanze im M\u00e4rz auf der Fensterbank vorzuziehen ist richtig. Die Pr\u00fcfung unterscheidet das jetzt und warnt nur im ersten Fall.'},
      {emoji:'\ud83d\udcca', bold:'Aufwand \u00fcber das Jahr:', text:' Eine zweite S\u00e4ulengrafik neben der Ernte zeigt, in welchen Monaten die Pflege dicht wird. Gez\u00e4hlt werden Handgriffe, keine Minuten \u2014 eine Dauer steht im Pflegeplan nicht drin und wird hier nicht erfunden.'},
    ],
  },
  {
    v: 'v31.75', date: '02.09.2026',
    headline: '\ud83d\udcc6 Der Planer denkt jetzt in Jahren, nicht in Beeten',
    summary: 'Neuer Reiter „Jahr": ein Balken je Kultur \u00fcber neun Monate, die leeren Zeitfenster daneben \u2014 mit Vorschl\u00e4gen aus der gepr\u00fcften Agronomie-Referenz. Dazu vier neue rechnende Pr\u00fcfungen: Aussaattermin, St\u00fcckzahl, Saatgut, Wasser.',
    user_summary: '\ud83d\udcc6 Der KI-Planer zeigt jetzt dein ganzes Gartenjahr \u2014 und sagt dir, wo dein Beet monatelang leer steht und was dort noch hineinpasst.',
    user_items: [
      {emoji:'\ud83d\udcc6', bold:'Das Gartenjahr auf einen Blick:', text:' Ein neuer Reiter zeigt jede Kultur als Balken \u00fcber die Monate M\u00e4rz bis November. Wo das Beet leer steht, sieht man sofort \u2014 und genau da liegt der gr\u00f6sste Hebel: derselbe Quadratmeter tr\u00e4gt oft drei Kulturen im Jahr statt einer.'},
      {emoji:'\ud83e\udde9', bold:'Was noch hineinpasst:', text:' Zu jeder L\u00fccke schl\u00e4gt die App Kulturen vor, deren Aussaat- und Erntemonate wirklich in das Zeitfenster fallen. Die Vorschl\u00e4ge stammen aus der gepr\u00fcften Agronomie-Referenz, nicht aus einer KI-Antwort \u2014 und Pflanzen derselben Familie sind ausgeschlossen, wegen der Fruchtfolge.'},
      {emoji:'\ud83c\udf31', bold:'Vier neue Pr\u00fcfungen, die wirklich rechnen:', text:' Liegt der Aussaattermin im gepr\u00fcften Fenster? Passen 12 Kohlrabi mit 30 cm Abstand \u00fcberhaupt auf 0,7 m\u00b2 (nein \u2014 dort passen 7)? Welches Saatgut liegt schon in deiner Schublade, und welches ist abgelaufen? Und wie viel Wasser bleibt nach dem gemessenen Regen an dir?'},
      {emoji:'\ud83e\uddfa', bold:'Ernte \u00fcber das Jahr:', text:' Eine kleine S\u00e4ulengrafik zeigt, in welchen Monaten wie viel reif wird \u2014 und in welchen gar nichts. Eine Zucchini-Schwemme im August neben einem leeren Mai ist kein guter Plan, auch wenn die Gesamtzahl stimmt.'},
      {emoji:'\ud83d\udcd0', bold:'Und der Entwurf dahinter:', text:' Der vollst\u00e4ndige Plan f\u00fcr V3 liegt jetzt als Dokument im Projekt \u2014 zehn Neuerungen, f\u00fcnf Stufen, und eine klare Trennlinie: was der Code ausrechnen kann, entscheidet nie die KI allein.'},
    ],
  },
  {
    v: 'v31.74', date: '02.09.2026',
    headline: '\ud83d\udd0d „Angemeldet bleiben" tat nichts \u2014 gefunden von einem neuen Pr\u00fcfstand',
    summary: 'Der Haken war vorangekreuzt, und wer ihn auf einem fremden Ger\u00e4t entfernte, blieb trotzdem angemeldet. Gefunden bei einer systematischen Pr\u00fcfung aller 303 Eingabefelder der App.',
    user_summary: '\ud83d\udd0d „Angemeldet bleiben" wirkt jetzt wirklich: Haken weg heisst, du bist beim n\u00e4chsten \u00d6ffnen des Browsers abgemeldet.',
    user_items: [
      {emoji:'\ud83d\udd12', bold:'Eine Zusage, die die App nicht hielt:', text:' Der Haken „Angemeldet bleiben" wurde beim Anmelden nie gelesen. Wer ihn auf einem geteilten Ger\u00e4t bewusst entfernte, blieb angemeldet \u2014 auf einem fremden Rechner keine Kleinigkeit. Jetzt gilt: Haken weg \u2192 beim n\u00e4chsten Browser-Start ist die Anmeldung weg. Deine Pflanzen, G\u00e4rten und Einstellungen bleiben \u2014 die geh\u00f6ren dem Ger\u00e4t, nicht der Sitzung.'},
      {emoji:'\ud83d\udd2c', bold:'Ein neuer Pr\u00fcfstand:', text:' `field_check.py` sucht Eingabefelder, die niemand liest \u2014 die Umkehrung der bisherigen Pr\u00fcfung. Anlass war der Fehler von gestern, bei dem die Gartenmasse nie gespeichert wurden. Von 303 Feldern blieb nach dem Aussieben genau eines \u00fcbrig, das wirklich nichts tat.'},
      {emoji:'\u26a0\ufe0f', bold:'Und was er NICHT findet:', text:' Zusammengesetzte Feldnamen kann keine Textsuche sehen \u2014 vier Felder sind so verdrahtet und funktionieren. Das steht jetzt im Pr\u00fcfstand selbst, damit der N\u00e4chste keine Gespenster jagt. Der erste Anlauf meldete \u00fcbrigens 172 von 172 Feldern als kaputt; ein Werkzeug, das alles f\u00fcr defekt erkl\u00e4rt, ist schlechter als keines.'},
    ],
  },
  {
    v: 'v31.73', date: '02.09.2026',
    headline: '\u2705 Planer V3: Der Plan wird zur Checkliste f\u00fcr deinen echten Garten',
    summary: 'Ein Plan war bisher ein Dokument \u2014 sch\u00f6n anzusehen, und danach musste man alles von Hand eintragen. Jetzt gibt es einen Reiter „Umsetzen": jede Pflanze antippen, und sie wird mit Position, Abstand, Tiefe und Pflanzdatum in deinem Garten angelegt.',
    user_summary: '\u2705 Neuer Reiter „Umsetzen" im Plan: Pflanze antippen \u2192 sie landet mit allen Angaben in deinem Garten. Abhaken, zur\u00fccknehmen, sp\u00e4ter weitermachen.',
    user_items: [
      {emoji:'\u2705', bold:'Der Plan wusste alles \u2014 nur \u00fcbernommen hat es niemand:', text:' Position, Abstand, Pflanztiefe, Wasserbedarf, Erntezeit standen im Plan. Wer sie im Garten haben wollte, musste sie abtippen. Jetzt gen\u00fcgt ein Tipp, und die Pflanze steht im Garten \u2014 mit „Position 0.4/0.2 m \u00b7 Abstand 60 cm \u00b7 Tiefe 2 cm \u00b7 8 l Wasser/Woche \u00b7 Ernte ab 10.07." in der Notiz.'},
      {emoji:'\u21a9\ufe0f', bold:'Und man kommt wieder heraus:', text:' Nochmal antippen nimmt die \u00dcbernahme zur\u00fcck und entfernt die Pflanzung wieder. Eine Liste, aus der man nicht heraus kommt, w\u00e4re eine Falle \u2014 ein Fehlgriff muss sich korrigieren lassen.'},
      {emoji:'\ud83d\udcbe', bold:'Der Fortschritt bleibt:', text:' „2 von 8 \u00fcbernommen" h\u00e4ngt am Plan, nicht am Bildschirm. Fenster schliessen, sp\u00e4ter wiederkommen \u2014 du siehst, was du schon gemacht hast. Und wenn der Speicher voll ist, sagt die App das, statt still zu vergessen.'},
      {emoji:'\ud83e\udeb4', bold:'Ohne Garten kein Blindflug:', text:' Hast du noch keinen Garten angelegt, steht das da \u2014 samt Knopf, der dich direkt zum Anlegen bringt. Eine Auswahlliste ohne Auswahl w\u00e4re eine Frage ohne Antwort.'},
    ],
  },
  {
    v: 'v31.72', date: '02.09.2026',
    headline: '\ud83d\udccf Die Gartenmasse wurden nie gespeichert \u2014 jetzt schon, und der Planer \u00fcbernimmt sie',
    summary: 'Im Garten-Formular gibt es Breite und L\u00e4nge, samt Fl\u00e4chen-Vorschau. Gespeichert hat sie nie jemand. Deshalb musste man die Masse im Planer jedes Mal neu eintippen. Dazu: der Planer \u00fcbernimmt jetzt einen bestehenden Garten, und beim Warten w\u00e4chst eine Pflanze.',
    user_summary: '\ud83d\udccf Deine Gartenmasse bleiben endlich gespeichert \u2014 und der KI-Planer \u00fcbernimmt sie mit einem Tipp. Beim Warten siehst du jedes Mal eine andere Pflanze wachsen.',
    user_items: [
      {emoji:'\ud83d\udccf', bold:'Ein Feld, das nie ankam:', text:' Du tippst 3 \u00d7 5 m ein, siehst „Fl\u00e4che: 15 m\u00b2", speicherst \u2014 und beim n\u00e4chsten \u00d6ffnen ist alles leer. Das Formular hatte die Felder, die Bearbeiten-Ansicht LAS sie sogar wieder ein, nur geschrieben hat sie niemand. Genau deshalb musstest du die Masse im Planer jedes Mal neu angeben.'},
      {emoji:'\ud83e\udeb4', bold:'Einen Garten \u00fcbernehmen:', text:' Ganz oben im Planer stehen jetzt deine G\u00e4rten. Ein Tipp \u00fcbernimmt Masse, Standort, Licht und Boden \u2014 und sagt dir genau, was \u00fcbernommen wurde. Ein Garten ohne Masse f\u00fcllt die Massfelder NICHT: erfundene Zahlen w\u00e4ren schlimmer als leere Felder.'},
      {emoji:'\ud83c\udf31', bold:'Beim Warten w\u00e4chst etwas:', text:' Statt eines pulsierenden Symbols der Lebenszyklus einer Pflanze \u2014 Same, Keimling, Bl\u00e4tter, Bl\u00fcte, Vergehen, neuer Same. Sieben Arten (Sonnenblume, Tomate, Apfelbaum, K\u00fcrbis, Mohn, Lavendel, Karotte), und bei jeder Runde eine andere. Wer Bewegung abgeschaltet hat, sieht ein stehendes Bild statt eines Zappelns.'},
      {emoji:'\ud83d\udd22', bold:'Und zwei erfundene Zahlen weniger:', text:' Der Ladebereich zeigte „5 %" und „~ 60 s", bevor \u00fcberhaupt etwas gelaufen war. Beide Platzhalter sind weg \u2014 sie werden gef\u00fcllt, sobald es etwas zu sagen gibt.'},
    ],
  },
  {
    v: 'v31.71', date: '02.09.2026',
    headline: '\u2705 „N\u00e4chste Schritte" zeigt nur noch Aufgaben \u2014 und die Bilanz l\u00e4sst sich zuklappen',
    summary: 'Der Wetter-Rat stand in der Aufgabenliste. Ein Schritt ist etwas, das man TUT und abhaken kann \u2014 „Morgen wird heiss" ist eine Lage. Er steht jetzt in der Wetterkarte, wo er hingeh\u00f6rt.',
    user_summary: '\u2705 In „N\u00e4chste Schritte" stehen nur noch Aufgaben. „Mein Garten in Zahlen" klappt auf und zu. Der Pflanzendoktor ist ins Men\u00fc gewandert.',
    user_items: [
      {emoji:'\u2705', bold:'Nur noch Aufgaben:', text:' Der Wetter-Rat ist aus der Liste raus. Ich hatte ihn dort hineingestellt, weil er wie die anderen eine Empfehlung ist \u2014 aber eine Liste, die „N\u00e4chste Schritte" heisst, geh\u00f6rt Dingen, die man abhaken kann. „Morgen wird heiss" verschwindet nie. Er steht jetzt in der Wetterkarte als deren Beschreibung: Frost, Regenaussicht, Trockenperiode \u2014 dort, wo er herkommt.'},
      {emoji:'\ud83d\udcca', bold:'Die Bilanz klappt zu:', text:' „Mein Garten in Zahlen" startet zugeklappt und merkt sich, wie du es zuletzt hattest. Die Bewegung l\u00e4uft weich \u00fcber die Rasterh\u00f6he statt \u00fcber eine geratene H\u00f6chsth\u00f6he \u2014 nichts wird abgeschnitten, nichts ruckt. Wer Bewegung abgeschaltet hat, bekommt den Wechsel sofort.'},
      {emoji:'\ud83e\ude7a', bold:'Der Pflanzendoktor ist im Men\u00fc:', text:' Samt Fragebogen und den vier weiteren Diagnose-Werkzeugen, die in ihm stecken. Auf „Mein Garten" ist damit keine Werkzeug-Zeile mehr \u00fcbrig \u2014 die Seite zeigt deinen Garten, was ansteht, was du tun kannst und wie das Wetter ist.'},
    ],
  },
  {
    v: 'v31.70', date: '01.09.2026',
    headline: '\ud83e\ude7a Der Pflanzendoktor bekommt einen Fragebogen \u2014 und „Mein Garten" gibt 18 Werkzeuge dorthin ab, wo sie hingeh\u00f6ren',
    summary: 'Drei zugeklappte Werkzeug-Gruppen sind von der Gartenseite verschwunden: die Diagnose-Werkzeuge stehen jetzt im Pflanzendoktor, die Planungs-Werkzeuge im KI-Planer, der Rest im Hauptmen\u00fc. Nichts ist weg \u2014 nachgemessen, alle 18 Eintr\u00e4ge sind erreichbar.',
    user_summary: '\ud83e\ude7a Der Pflanzendoktor fragt jetzt nach: sechs Fragen zum Antippen ergeben eine deutlich genauere Diagnose. Und „Mein Garten" ist um drei Werkzeug-Gruppen leichter.',
    user_items: [
      {emoji:'\ud83e\ude7a', bold:'Sechs Fragen statt eines leeren Feldes:', text:' Seit wann? Wo an der Pflanze? Breitet es sich aus? Standort, zuletzt gegossen, zuletzt ged\u00fcngt. Genau diese Fragen standen vorher als grauer Beispieltext in einem leeren Notizfeld \u2014 und wurden deshalb kaum beantwortet. Jetzt sind es Antworten zum Antippen, alle freiwillig, und was du beantwortest geht in die Diagnose.'},
      {emoji:'\ud83d\udd2c', bold:'Warum gerade diese Fragen:', text:' Junge oder alte Bl\u00e4tter trennt Stickstoff- von Eisenmangel. Eine Pflanze oder mehrere trennt ein Standortproblem von einer Krankheit. Das sind die Fragen, die ein Pflanzenarzt zuerst stellt.'},
      {emoji:'\ud83d\udce6', bold:'Achtzehn Werkzeuge sind umgezogen:', text:' Sch\u00e4dling-Scanner, Krankheits-Lexikon und die zwei Boden-Werkzeuge stehen jetzt IM Pflanzendoktor, unter der Diagnose \u2014 dort, wo man sie sucht, wenn die Diagnose allein nicht reicht. Saisonkalender, Beet-Vorlagen, Forest-Garden und die gespeicherten Pl\u00e4ne stehen im KI-Planer. Achievements, Bibliothek, Insights, Erntekalender, Tagebuch, Voice-Mode und das Sensor-Dashboard im Hauptmen\u00fc \u2014 dort sind sie durchsuchbar.'},
      {emoji:'\u2705', bold:'Nachgemessen, nicht gehofft:', text:' Alle 18 Ziele wurden am laufenden Programm gepr\u00fcft \u2014 jedes ist von mindestens einer Stelle aus erreichbar, keines begraben. Die Gartenseite ist dabei von 213 auf 132 Elemente geschrumpft.'},
    ],
  },
  {
    v: 'v31.69', date: '01.09.2026',
    headline: '\u2705 „N\u00e4chste Schritte" \u2014 drei Widgets, die dasselbe sagten, sind eins geworden',
    summary: 'Der Wetter-Rat, die f\u00e4lligen Pflege-Aufgaben und „Im September im Garten" standen als drei getrennte K\u00e4sten da und beantworteten dieselbe Frage. Jetzt eine Liste. Und die Morgen-Prognose steht in der Wetterkarte statt in einem zweiten Wetter-Widget.',
    user_summary: '\u2705 Alles, was ansteht, in einer Liste: Wetter-Warnung, f\u00e4llige Pflege, Saison-Aufgaben. Und nur noch EIN Wetter-Widget \u2014 mit Prognose auf morgen.',
    user_items: [
      {emoji:'\u2705', bold:'Eine Liste statt drei K\u00e4sten:', text:' „N\u00e4chster Schritt", der Wetter-Ratgeber („Morgen wird heiss", „Frost in den n\u00e4chsten Stunden") und „Im September im Garten" sagten alle dasselbe: was jetzt zu tun ist. Jetzt eine Liste, nach Dringlichkeit sortiert \u2014 zeitkritisches oben mit rotem Streifen, dann die f\u00e4llige Pflege (direkt abhakbar), dann die Saison-Aufgaben.'},
      {emoji:'\ud83c\udf24\ufe0f', bold:'Nur noch ein Wetter-Widget:', text:' Die Prognose auf morgen steht jetzt in der Wetterkarte selbst \u2014 „Morgen \u2600\ufe0f 29\u00b0 / 18\u00b0 \u00b7 45 % Regen". Regen erscheint nur, wenn er eine Rolle spielt: „0 % Regen" ist keine Information.'},
      {emoji:'\ud83d\udd0e', bold:'Ein Feld, das gefehlt h\u00e4tte:', text:' Die Regenwahrscheinlichkeit wurde von der Wetter-Schnittstelle gar nicht abgefragt. Der Code h\u00e4tte richtig ausgesehen und den Regen NIE angezeigt \u2014 aufgefallen beim Nachrechnen, nicht beim Lesen. Und f\u00fcr \u00e4ltere zwischengespeicherte Antworten gibt es einen R\u00fcckfall auf Millimeter.'},
      {emoji:'\ud83d\udcca', bold:'Die Zahlen nach unten:', text:' „Mein Garten in Zahlen" ist eine Bilanz \u2014 man liest sie, wenn man sonst nichts mehr sucht, nicht bevor man gesehen hat, was ansteht.'},
    ],
  },
  {
    v: 'v31.68', date: '01.09.2026',
    headline: '\ud83e\udeb4 Deine G\u00e4rten stehen jetzt ganz oben \u2014 und die Seite hat endlich eine Gliederung',
    summary: 'Auf einer Seite namens „Mein Garten" standen die eigenen G\u00e4rten an zehnter Stelle, hinter Wetter, Werkzeugen, Mond und Statistik. Und zehn gleich aussehende Karten ohne \u00dcberschrift lasen sich als Chaos.',
    user_summary: '\ud83e\udeb4 Deine G\u00e4rten kommen zuerst. Darunter vier klare Abschnitte: Mein Garten \u00b7 Tun \u00b7 Heute \u00b7 Werkzeuge.',
    user_items: [
      {emoji:'\ud83e\udeb4', bold:'Der eigene Garten zuerst:', text:' Er stand an zehnter Stelle \u2014 hinter dem Wetter, den Werkzeugkacheln, dem Mondkalender und der Statistik. Wer „Mein Garten" \u00f6ffnet, sucht seinen Garten. Jetzt steht er direkt unter der Kopfzeile, mit „+ Garten" gleich daneben.'},
      {emoji:'\ud83d\udcd1', bold:'Vier Abschnitte statt eines Stapels:', text:' MEIN GARTEN (deine G\u00e4rten, die Zahlen dazu, was ansteht) \u00b7 TUN (einpflanzen, planen, scannen) \u00b7 HEUTE (Wetter und Mond) \u00b7 WERKZEUGE. Das Chaos kam nicht von der Menge, sondern davon, dass zehn gleich aussehende Karten nichts dar\u00fcber sagten, was zusammengeh\u00f6rt.'},
      {emoji:'\u2600\ufe0f', bold:'Wetter und Mond in einer Karte:', text:' Beide beantworten dieselbe Frage \u2014 wie ist es heute? \u2014 und standen als zwei Karten mit zwei R\u00e4ndern untereinander. Jetzt ein Block mit zwei Zeilen, beide weiterhin einzeln antippbar.'},
      {emoji:'\ud83d\udd22', bold:'Ein Widerspruch, den erst die neue Reihenfolge zeigte:', text:' Auf den Gartenkarten stand „0 Pflanzen", direkt darunter „8 Pflanzen in Pflege". Beides stimmte, aber es sind zwei Dinge: was in EIN Beet eingepflanzt ist, und wie viele Pflanzen du insgesamt pflegst. Jetzt sagt die Karte „0 gepflanzt".'},
    ],
  },
  {
    v: 'v31.67', date: '01.09.2026',
    headline: '\ud83c\udf31 Echter Rasen im 3D-Modell \u2014 und ein Scanner-Knopf, der nicht mehr ins Leere zeigt',
    summary: 'Der Rasen war eine glatte gr\u00fcne Fl\u00e4che, das Beet wirkte daraufgeklebt. Und wenn dein Ger\u00e4t keine Kamera hat, bot der Scanner „Kamera erneut \u00f6ffnen" als gr\u00f6ssten Knopf an \u2014 die einzige Aktion, die dort nie klappen kann.',
    user_summary: '\ud83c\udf31 Das 3D-Modell steht jetzt auf echtem Gras statt auf Filz. Und ohne Kamera zeigt dir der Scanner den Weg, der funktioniert, statt den, der gerade gescheitert ist.',
    user_items: [
      {emoji:'\ud83c\udf3e', bold:'Rasen statt Filz:', text:' Statt einer Volltonfarbe eine gemalte Grasfl\u00e4che mit unregelm\u00e4ssigen Halmen. Dazu ein weicher Schatten rings um das Beet \u2014 der Sonnenschatten trifft nur eine Seite, aber etwas, das auf dem Boden steht, dunkelt ihn ringsum ab. Ohne diesen Kontakt schwebt alles.'},
      {emoji:'\ud83d\udcf7', bold:'Der Knopf, der nicht funktionieren konnte:', text:' Ohne Kamera sagte der Text „bitte Foto hochladen" \u2014 und der auff\u00e4lligste Knopf der Seite bot „Kamera erneut \u00f6ffnen" an. Die Gewichtung stand auf dem Kopf. Jetzt ist der Weg, der JETZT geht, der Hauptweg; und hat das Ger\u00e4t gar keine Kamera, verschwindet der Wiederholen-Knopf ganz. Bei fehlender Erlaubnis oder belegter Kamera bleibt er \u2014 da kannst du etwas \u00e4ndern.'},
      {emoji:'\ud83c\udff7\ufe0f', bold:'Die Namensschilder dr\u00e4ngeln weniger:', text:' Sie werden erst nach einer Sekunde Best\u00e4ndigkeit ein- oder ausgeblendet und w\u00e4hrend der Er\u00f6ffnungsdrehung seltener neu geordnet. Gemessen: Zustandswechsel in f\u00fcnf Sekunden von 14 auf 8, und 78 bis 100 % der Schilder bleiben sichtbar.'},
      {emoji:'\ud83d\udcd0', bold:'Gemessen statt geraten:', text:' Ich hatte die H\u00f6henstufen der Schilder von drei auf vier erh\u00f6ht, weil es plausibel klang. Vier Varianten am eingeschwungenen Bild durchgemessen: drei Stufen sind mit 79 % am besten, vier nur 64 %. Mehr ist hier nicht besser \u2014 hoch gestapelte Schilder wandern in den Bereich der Nachbarn dahinter.'},
    ],
  },
  {
    v: 'v31.66', date: '01.09.2026',
    headline: '\ud83c\udff7\ufe0f Das 3D-Modell hat jetzt Namensschilder \u2014 und „Mein Garten" sieht endlich nach einem St\u00fcck aus',
    summary: 'Im Modell waren Hecke, Kohl und Basilikum drei gr\u00fcne Formen ohne Namen \u2014 h\u00fcbsch, aber nicht lesbar. Und auf der Gartenseite klaffte ein 100 Pixel hohes Loch mitten im Layout, das seit Jahren niemand bemerkt hat.',
    user_summary: '\ud83c\udff7\ufe0f Jede Pflanze im 3D-Modell tr\u00e4gt jetzt ihren Namen. Und „Mein Garten" ist noch einmal k\u00fcrzer und deutlich aufger\u00e4umter.',
    user_items: [
      {emoji:'\ud83c\udff7\ufe0f', bold:'Namen im Modell:', text:' Ein Plan, den man nicht lesen kann, ist Dekoration. Jede Pflanze bekommt ein Schild, das sich immer zur Kamera dreht \u2014 grau f\u00fcr das, was schon dasteht, mit gr\u00fcnem Rand f\u00fcr Vorschl\u00e4ge, genau wie die Ringe am Boden. Gruppen zeigen die Anzahl: „Karotte \u00d712".'},
      {emoji:'\ud83d\udc41\ufe0f', bold:'Und sie dr\u00e4ngeln sich nicht:', text:' Bei einem vollen Beet lagen die Schilder \u00fcbereinander. Jetzt stehen sie auf vier festen H\u00f6hen, werden bei vielen Pflanzen kleiner, und was sich trotzdem \u00fcberdeckt, tritt zur\u00fcck \u2014 das vordere gewinnt. Gemessen: bei drei bis f\u00fcnf Pflanzen sind alle Schilder da, bei zw\u00f6lf noch drei Viertel.'},
      {emoji:'\ud83d\udd73\ufe0f', bold:'Ein 100-Pixel-Loch:', text:' Zwischen der letzten Gartenkarte und „Einpflanzen" klaffte eine leere Fl\u00e4che. Ursache: eine Regel, die Listen einen Sockel gibt, damit ihr Ende nicht hinter der Navigationsleiste verschwindet \u2014 nur ist die Gartenliste gar nicht das Letzte auf der Seite.'},
      {emoji:'\u2728', bold:'Und die Seite als Ganzes:', text:' Drei Zahlen stehen jetzt nebeneinander in einer Zeile statt in vier grossen Kacheln (72 statt 300 Pixel). Der Mondkalender war der einzige dunkelblaue Balken zwischen lauter hellen Karten \u2014 jetzt tr\u00e4gt er dieselbe Karte. Die drei Werkzeug-Gruppen standen als nackter Text auf dem Grund und sind jetzt ebenfalls Karten. Nochmals 10 bis 13 % k\u00fcrzer, bei exakt gleich vielen Kn\u00f6pfen.'},
    ],
  },
  {
    v: 'v31.65', date: '01.09.2026',
    headline: '\ud83d\udd0d Der Planer sagt jetzt, was er gepr\u00fcft hat \u2014 und ein Speicher-Fehler, der den ganzen Scan fressen konnte',
    summary: 'Vor dem Plan stapelten sich bis zu vier Hinweiskästen; jetzt ist es eine Tafel, die auch sagt, was NICHT gepr\u00fcft werden konnte. Der Fortschrittsbalken erfindet keine Stufen mehr. Und beim Nachstellen mit einem echten Telefonfoto kam ein Fehler heraus, den ich selbst gebaut hatte.',
    user_summary: '\ud83d\udd0d Eine „Plan-Pr\u00fcfung" statt vier K\u00e4sten \u2014 und sie sagt dir auch, wenn etwas nicht gepr\u00fcft werden konnte, statt einfach zu schweigen.',
    user_items: [
      {emoji:'\ud83d\udd0d', bold:'Eine Tafel statt vier K\u00e4sten:', text:' Bestand, Licht, Nachbarn und Platz standen als vier eigene Hinweiskästen \u00fcbereinander \u2014 bis zu 400 Pixel, bevor du eine einzige Pflanze sahst. Jetzt eine Zeile je Pr\u00fcfung, 21 bis 30 % k\u00fcrzer. Und der wichtigere Teil: konnte eine Pr\u00fcfung nicht laufen, stand da vorher GAR NICHTS \u2014 „gepr\u00fcft und gut" sah aus wie „nicht pr\u00fcfbar". Jetzt steht der Grund da.'},
      {emoji:'\u23f3', bold:'Der Fortschrittsbalken erfindet nichts mehr:', text:' Er zeigte sieben Meldungen wie „Mischkultur-Kombinationen pr\u00fcfen \u2026" mit Prozentzahl und Restzeit \u2014 alles nach Uhr, w\u00e4hrend die App in Wahrheit auf eine einzige Antwort wartete. Jetzt melden nur Schritte, die wirklich passieren, und w\u00e4hrend des Wartens steht dort die einzige ehrliche Angabe: wie lange es schon l\u00e4uft.'},
      {emoji:'\ud83d\udcbe', bold:'Ein Fehler, der den ganzen Garten-Scan fressen konnte:', text:' Bei vollem Ger\u00e4tespeicher sollte das Foto weichen und die Erkennung bleiben. Der Rettungsweg lief nie \u2014 die App f\u00e4ngt Speicherfehler global ab, also kam die Ausnahme nie an, auf die er wartete. Auf einem vollen Ger\u00e4t war damit der KOMPLETTE Scan weg, und die App meldete Erfolg. Jetzt bleibt die Erkennung, das Foto weicht, und du erf\u00e4hrst es.'},
      {emoji:'\u26a0\ufe0f', bold:'Zwei Warnungen, die es nie auf den Bildschirm schafften:', text:' Dieselbe Ursache an zwei weiteren Stellen: „Speicher voll \u2014 Favorit evtl. nicht gesichert" und „Speicher voll \u2014 Key konnte nicht gespeichert werden" waren seit v30.46 bzw. v28.67 eingebaut und sind nie erschienen. Beide gehen jetzt.'},
    ],
  },
  {
    v: 'v31.64', date: '01.09.2026',
    headline: '\ud83e\uddf9 „Mein Garten" ist ein F\u00fcnftel k\u00fcrzer \u2014 ohne dass ein einziger Knopf fehlt',
    summary: 'Die Seite war fast zwei Bildschirme lang und zeigte manches doppelt. Jetzt 19 bis 20 % k\u00fcrzer, zwei Bl\u00f6cke weniger \u2014 und die Zahl der antippbaren Stellen ist exakt dieselbe geblieben.',
    user_summary: '\ud83e\uddf9 „Mein Garten" ist rund ein F\u00fcnftel k\u00fcrzer. Gemessen: gleich viele Kn\u00f6pfe wie vorher, nur weniger Scrollen.',
    user_items: [
      {emoji:'\ud83d\udd01', bold:'Der Titel stand zweimal da:', text:' Ganz oben „\ud83c\udf3b Mein Garten \u00b7 Planen \u00b7 Pflegen \u00b7 Ernten" \u2014 und 20 Pixel darunter noch einmal „Mein Garten \u00b7 Dein digitaler Garten\u00fcberblick". Die vier Kacheln sagen ohnehin, was sie sind.'},
      {emoji:'\ud83c\udf19', bold:'Der Mondkalender ist eine Zeile:', text:' Vorher ein Block mit grossem Mond, Phase, Alter, Beleuchtung, Plakette und Gartentipp \u2014 123 Pixel. Jetzt dieselbe Form wie die Wetterkarte dar\u00fcber, 55 Pixel. Alles Weggefallene steht im Mondkalender, den ein Tipp \u00f6ffnet.'},
      {emoji:'\ud83d\udccb', bold:'Gartenkarten in einer Zeile statt zwei:', text:' Standort, Pflanzenzahl, Gr\u00f6sse und Licht standen als Text plus zwei Plaketten untereinander. Vier kurze Angaben brauchen keine zweite Zeile \u2014 das spart 20 Pixel je Garten, bei sechs G\u00e4rten also 120.'},
      {emoji:'\ud83c\udfc6', bold:'Und einer, der beinahe schiefgegangen w\u00e4re:', text:' Die Achievements-Kachel sollte weg \u2014 sie war die f\u00fcnfte in einem Zweierraster und machte aus zwei Reihen drei mit einer Waise. Beim Nachsehen stellte sich heraus: es gab AUSSER ihr keinen Weg zu den Achievements. Sie ist deshalb in die eingeklappte Gruppe „Wissen & Werkzeuge" gewandert, nicht in den Papierkorb.'},
    ],
  },
  {
