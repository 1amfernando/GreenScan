// 410-Gone-Stub (v30.88, 2026-08-28) — Aeltere Dublette des aktiven Portal-Endpunkts.
//
...
// Ersatz / heute genutzt: stripe-portal
Deno.serve(() => new Response(
  JSON.stringify({ error: 'gone', replacement: 'stripe-portal', deprecated_at: '2026-08-28' }),
