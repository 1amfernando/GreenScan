// 410-Gone-Stub (v30.88, 2026-08-28) — Aeltere Dublette des aktiven Checkout-Endpunkts.
//
...
// Ersatz / heute genutzt: stripe-checkout
Deno.serve(() => new Response(
  JSON.stringify({ error: 'gone', replacement: 'stripe-checkout', deprecated_at: '2026-08-28' }),
