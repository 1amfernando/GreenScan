// 410-Gone-Stub (v30.88, 2026-08-28) — Einmaliges Preis-Umbau-Tool (Setup-Zeit v25.38).
//
...
// Ersatz / heute genutzt: stripe-checkout / Stripe-Dashboard
Deno.serve(() => new Response(
  JSON.stringify({ error: 'gone', replacement: 'stripe-checkout / Stripe-Dashboard', deprecated_at: '2026-08-28' }),
