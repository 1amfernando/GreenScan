...
| B2 | 76 Tabellen mit multiple permissive Policies | mittel | M–L | [V] | Permissive Policies pro Tabelle/cmd zu OR-Policy mergen (Fortsetzung v28.18). **Risiko auf Live-Payment-DB → Per-Policy-Review** (= deferred Perf-Sprint aus CLAUDE.md). |
