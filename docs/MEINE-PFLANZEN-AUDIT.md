...
Stufe 2 (v32.47) hat 1, 8 und 10 geschlossen; 3 zur Hälfte (das
Cloud-Tagebuch fehlt noch in der Sicht). Offen bleiben 7 (Notizzettel —
eine CSS-Zeile mit einer Messung davor: Zettel-Position gegen die
Karten-Pfeile bei 0, 1, 3 und 8 fälligen Aufgaben), 9 (Migration) und 11
(Entscheidung). Die Befunde dieser Liste gehen durch die gegnerische
